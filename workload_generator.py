...
class WorkloadGenerator:
    ...
    def run(self, duration_seconds=60):
        ...
        try:
            ...
            # Clear the line and create a template for status updates
            ...
            while time.time() - start_time < duration_seconds:
                ...
                # Calculate operations in this batch
                inserts = len(new_ids)
                updates = len(new_ids)  # Now updating all records
                deletes = len(new_ids)  # Now deleting all records
                ...
                # Update status with progress bar on three lines
                status = (
                ...
                # Move cursor up two lines after printing to maintain position
            ...
            # Add an extra newline before final statistics
            print("\n")
            end_time = time.time()
